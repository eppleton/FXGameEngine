...
public class Sprite  {
    ...
    private static Animation NO_ANIMATION = new Animation() {
        @Override
    ...
    public Sprite(GameCanvas parent, String name, double x, double y, int width, int height) {
        this.parent = parent;
    ...
    public void pulse(GameCanvas field) {
